...
const RealtimeInteractives: CollectionConfig = {
  slug: 'realtimeInteractives',
  labels: {
    singular: "Realtime Interactive",
    plural: "Realtime Interactive",
  },    
  admin: {
    useAsTitle: 'title',
    group: 'Rules',
...
export default RealtimeInteractives;